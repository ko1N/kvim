...
use crate::server::LanguageServerDeclaration;
...
impl FormatterRequest {
    ...
    /// Returns the complete buffer revision that this run formats.
    #[must_use]
...
impl FormattedDocument {
    /// Returns the complete buffer revision that produced this document.
    #[must_use]
    pub const fn revision(&self) -> BufferRevision {
        self.revision
    }
