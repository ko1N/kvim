...
//!
//! The module knows no terminal type except the normalized [`Key`]. It holds no
...
pub use registry::{Binding, KeySequence, Registry, RegistryError, WhichKeyRow};
pub use resolver::{Expiry, PromptEdit, Resolution, Resolver};
