...
use crate::settings::{Rgb, ThemeSettings};
...
///
/// A language adapter emits these roles, and this module maps each one to a
/// color. Slice 12 adds the Rust adapter that produces them, so no call site
/// requests a syntax role yet. See `docs/language-services.md`.
...
///
/// ```
/// use kvim::settings::ThemeSettings;
/// use kvim::tui::{Theme, ThemeRole};
///
...
mod tests {
    ...
    use super::{SyntaxRole, Theme, ThemeRole};
