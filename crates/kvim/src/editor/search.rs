...
use crate::core::{CharPosition, TextBuffer};
use crate::settings::{CaseSensitivity, SearchSettings};
...
///
/// ```
/// use kvim::editor::SearchDirection;
///
...
/// use kvim::editor::{SearchDirection, SearchQuery};
/// use kvim::settings::{FileSettings, SearchSettings};
///
