...
pub use worktree::{
    ...
    FileSidebarCommand, FileSidebarDimming, FileSidebarGitState, FileSidebarIconRole,
    FileSidebarLabelMatch, FileSidebarNoticeKind, FileSidebarOutcome, FileSidebarRow,
    FileSidebarRowId, FileSidebarRowKind, FileSidebarSnapshot, FileSidebarSymlinkState,
    PROCESS_CAPACITY_MAX, ServicePolicy, SurfaceOwnership, WORKER_CAPACITY_MAX,
