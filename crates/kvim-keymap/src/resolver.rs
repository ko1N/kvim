...
//! the same registry through a context that names a host-global scope, reads
//! [`Resolver::idle_which_key`] before any key is pressed, and there a
//! host-global key cancels the pending editor sequence and runs.
